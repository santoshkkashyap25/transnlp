...
st.set_page_config(page_title="Content Success Predictor", layout="wide")

st.title("Content Success Predictor")
st.write("Forecast the potential IMDb rating of new content based on its textual content.")

# --- Input Section ---
st.subheader("Input Content Script/Synopsis")
input_text = st.text_area(
    "Paste your content script, early draft, or detailed synopsis here:",
    height=300,
    placeholder="e.g., 'This comedy special explores the absurdity of modern politics and relationships...'",
...
if st.button("Predict Success", key="predict_button"):
    if content_to_analyze and len(content_to_analyze.strip()) >= 50:
        with st.spinner("Analyzing content and predicting success..."):
            try:
